  ...
  return (
    <footer className="relative bg-white border-t-4 border-brand-ink py-16 px-6 overflow-hidden select-none">
      ...
      <div className="relative z-20 text-center text-[10px] sm:text-xs md:text-sm font-mono text-brand-ink/65 tracking-wider font-bold mb-10 max-w-7xl mx-auto border-b-2 border-brand-ink/10 pb-6 flex flex-wrap items-center justify-center gap-1.5 uppercase">
        <div 
          className="flex flex-wrap items-center justify-center gap-1.5 px-4 py-2 sm:p-0"
        >
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-mono text-brand-ink/65">
        <div className="text-center md:text-left font-bold">
          &copy; 2026 International Conference - JK Lakshmipat University. All rights reserved.
        </div>
        
        <div className="flex items-center gap-6">
          <Link href="/" className="cursor-pointer transition-transform hover:scale-[1.03] active:scale-95 flex flex-col select-none text-brand-ink">
            <span className="font-extrabold text-base tracking-widest uppercase text-brand-orange font-sans leading-none">
              ICATS
            </span>
            <span className="font-semibold text-[9px] tracking-widest uppercase text-brand-pink font-sans leading-none mt-1">
              Conference 2026
            </span>
          </Link>
          <a 

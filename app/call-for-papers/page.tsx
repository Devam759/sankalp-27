...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Call for Papers - SANKALP '27 | JKLU Jaipur",
    description: "Submit original research papers in Sustainable AI, Data Science, and Emerging Tech for Sankalp 2027 at JK Lakshmipat University.",

...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "academic conference jaipur",
    "research conference jaipur",
    "conference in rajasthan",
    "conference in india 2027",
    "AI conference india",
    "AI conference jaipur",
    "machine learning conference india",
    "computer science conference india 2027",
    "engineering conference jaipur",
    "technology conference india 2027",
    "data science conference india",
    "IEEE conference jaipur",
    "Scopus indexed conference india",
    "Springer conference india 2027",
    "best conference for paper publication india",
    "UGC approved conference 2027",
    "international conference rajasthan 2027",
    "multidisciplinary conference jaipur",
    "VLSI conference india",
    "HPC conference india",
    "smart healthcare conference india",
    "IoT conference jaipur",
    "cybersecurity conference india 2027",
    "sustainable technology conference",
    "next gen technology conference india",
    "academic conference for students india",
    "research paper conference jaipur 2027",
    "jklu conference 2027",
    "jklu jaipur conference",
    "IET JKLU conference"
  ],

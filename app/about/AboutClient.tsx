      ...
      <section className="relative py-32 bg-brand-cloud overflow-hidden border-t border-brand-blue/10">
        ...
        <div className="max-w-[1440px] w-full mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
           ...
           {/* Spread Sub-Centres & Ecosystem under JKLU / IET across full width */}
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mt-12 md:mt-16">
              ...
              >
                 <div>
                   <span className="text-[11px] font-bold text-brand-orange uppercase tracking-wider block mb-2">Startup Incubator</span>
                   <h4 className="font-serif font-bold text-brand-blue text-lg mb-3">Atal Incubation Centre (AIC-JKLU)</h4>
                   <p className="text-slate-600 text-sm leading-relaxed">
                     Supported by AIM, NITI Aayog; nurtures 70+ early-stage startups with 33+ specialized labs, seed grants, corporate networks, and mentor ecosystems.
                   </p>
                 </div>
              </motion.div>
           </div>

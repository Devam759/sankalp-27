...
export default function CommitteePage() {
  ...
  const personSchemas = [
    ...
    },
    {
      ...
      '@type': 'Person',
      name: 'Mr. Prem Singh',
      alternateName: ['Prem Singh'],
      jobTitle: 'Patron',
      worksFor: { '@type': 'Organization', name: 'JK Organisation', url: 'https://jkorganisation.com' },
      image: 'https://sankalp.jklu.edu.in/prem-singh.webp',
      url: 'https://sankalp.jklu.edu.in/committee',
      sameAs: ['https://www.linkedin.com/in/prem-singh-7140bb8/'],
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Person',
